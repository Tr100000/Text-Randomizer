        ...
        return YetAnotherConfigLib.createBuilder()
            ...
            .category(ConfigCategory.createBuilder()
                ...
                .option(Option.<Boolean>createBuilder()
                    ...
                    .binding(true, () -> ModConfig.modEnabled, newValue -> ModConfig.modEnabled = newValue)
                    .flag(OptionFlag.ASSET_RELOAD)
                    .controller(TickBoxControllerBuilder::create)
                    .build())
                .option(Option.<Boolean>createBuilder()
                    .name(Text.literal("Ignore Format Specifiers"))
                    .binding(false, () -> ModConfig.ignoreFormatSpecifiers, newValue -> ModConfig.ignoreFormatSpecifiers = newValue)
                    .flag(OptionFlag.ASSET_RELOAD)
